...
public class DuplicateLead {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("createLeadForm_companyName")).sendKeys("ArunRama");
		driver.findElement(By.id("createLeadForm_firstName")).clear();
		driver.findElement(By.id("createLeadForm_firstName")).sendKeys("RAMA");
		WebElement elementLeadClick1 = driver.findElement(By.className("smallSubmit"));
		elementLeadClick1.click();
